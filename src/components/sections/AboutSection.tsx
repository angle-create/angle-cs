            ...
            <div className="md:hidden mb-16">
              <div className="flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide">
                <motion.div
                  ...
                  transition={{ duration: 0.8, delay: 0.1 }}
                  viewport={{ once: true }}
                  className="min-w-[280px] sm:min-w-[320px] border border-green-100 hover:border-green-300 p-6 rounded-lg shadow-sm hover:shadow transition-all duration-300 snap-center"
                >
                  <div className="flex items-center justify-center w-12 h-12 mb-6 rounded-full bg-green-50 text-green-600">
                    <Eye size={24} strokeWidth={2} />
                  </div>
